...
export default function Page() {
  ...
  const saveMap = async () => {
    ...
    if (editing) {
      ...
      if (res.ok) {
        setMaps(current => current.map(m => m.id === editing.id ? data.data : m))
      }
    } else {
    ...
    >
      ...
      <SidebarInset>
        ...
        <div className="p-4 space-y-4">
          ...
          {loading ? (
            <p className="text-sm text-muted">Loading maps...</p>
          ) : (
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  {editing ? "Update name, enabled status, or replace image." : "Upload an image and name your map."}
                </DialogDescription>
              </DialogHeader>
